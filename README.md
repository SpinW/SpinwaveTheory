...
This can be published by creating a gh-pages branch and will be served at `www.spinw.org/BasicPresentation`. An accompanying post should be created in the `spinw.github.io` repo under `pages/_presentations` so it is automatically published from the main site.
